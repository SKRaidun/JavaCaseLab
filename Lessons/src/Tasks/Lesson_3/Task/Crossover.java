...
final class Crossover extends Car implements Moveable {
    ...
    public Crossover(Color color, String model, String manufactureYear, double weight, double maxSpeed, String transmissionType, String brand, String engineType, double volume, double horsePower, String bodyType, int doorsNumber, int wheelNumber) {
